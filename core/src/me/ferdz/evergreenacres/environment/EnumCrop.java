...
public enum EnumCrop {
	POTATO(1, Textures.IconTexture.POTATO, 6, Items.POTATO, CropTexture.POTATO_0, CropTexture.POTATO_1, CropTexture.POTATO_2, CropTexture.POTATO_3, CropTexture.POTATO_4, CropTexture.POTATO_5, CropTexture.POTATO_6);
